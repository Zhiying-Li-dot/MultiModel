...
## Baseline 实验结果 (2026-01-04)

### 实验配置

| 项目 | 值 |
|------|-----|
| 输入视频 | `bracelet_shot1_480p.mp4` (832×480, 49帧, 3s) |
...
- 输入：`experiments/baseline/bracelet_shot1_480p.mp4`
- 输出：`experiments/baseline/flowalign_bracelet_to_necklace.mp4`
